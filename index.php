 ...
 <body>
   ...
   <?php
      ...
      $clm_header = array("id", "Nome articolo", "Gruppo Filler Metal", "SFA / AWS", "EN ISO", "Diametro", "Colata / lotto",
                  "unità di misura", "quantità", "Trattamento termico", "Tempo di permanenza ", "Ordine", "Data di carico", "Data di aggiornamento", "Note", "Attiva?"); //Qui l'Header è uguale al nome delle colonne del DB --> si possono settare dei nomi formattati meglio
 ...
 <?php
    ...
    $entry1->db_connection_on();
	  if(isset($_POST['submit']))
      {
        ...
        // header("Location: /SIFEA_ISO/viewer.php");
      }
