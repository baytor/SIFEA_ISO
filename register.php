...
<body>
  ...
  <section class="menu menu1 cid-sGZyBNv80e" once="menu" id="menu1-s">
...
<div>
    <?php
	include($_SERVER['DOCUMENT_ROOT'].'/SIFEA_ISO/php_code/register_code.php');
	?>
</div></div>

<section class="footer7 cid-sGZyBNViqj mbr-reveal" once="footers" id="footer7-t">
