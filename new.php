...
<body>
  ...
  <section class="menu menu1 cid-sGZyJl6NZ6" once="menu" id="menu1-v">
...
<div>
    <?php
	include($_SERVER['DOCUMENT_ROOT'].'/SIFEA_ISO/php_code/new_code.php');
	?>
</div></div>

<section class="footer7 cid-sGZyJlxiQM mbr-reveal" once="footers" id="footer7-w">
